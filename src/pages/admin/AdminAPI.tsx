...
import {
    ...
    updateApiConfigurations,
    DEFAULT_API_CONFIG,
    type ApiConfigurationsFormData,
} from "@/lib/api-configurations";
import { toast } from "sonner";

const AdminAPI = () => {
    const [formData, setFormData] =
        useState<ApiConfigurationsFormData>(DEFAULT_API_CONFIG);
            ...
            if (config) {
                setFormData({
                    ...
                    fb_api_version:
                        ...
                        DEFAULT_API_CONFIG.fb_api_version,
                    ...
                    pathao_base_url:
                        config.pathao_base_url ||
                        DEFAULT_API_CONFIG.pathao_base_url,
                    pathao_enabled: config.pathao_enabled || false,
                    // RedX
                    redx_api_token: config.redx_api_token || "",
                    redx_base_url:
                        config.redx_base_url ||
                        DEFAULT_API_CONFIG.redx_base_url,
                    ...
                    stedfast_base_url:
                        config.stedfast_base_url ||
                        DEFAULT_API_CONFIG.stedfast_base_url,
                    ...
                    sslcommerz_sandbox_mode:
                        config.sslcommerz_sandbox_mode ?? true,
    ...
    const handleInputChange = (
        field: keyof ApiConfigurationsFormData,
        ...
        <div className="space-y-6">
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>
                        Configure Facebook Conversion API for tracking
                    ...
                    <div className="flex items-center space-x-2">
                        <Switch
                            ...
                            onCheckedChange={(checked) =>
                                handleInputChange("fb_enabled", checked)
                            }
                        />
                        <Label htmlFor="fb_enabled">
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>
                        Configure Google Tag Manager, Analytics, and Ads
                        conversion tracking
                    </CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                    <div className="flex items-center space-x-2">
                        <Switch
                            ...
                            onCheckedChange={(checked) =>
                                handleInputChange("gtm_enabled", checked)
                            }
                        />
                        <Label htmlFor="gtm_enabled">
            ...
            <Card>
                ...
                <CardContent className="space-y-6">
                    ...
                    <div className="space-y-4">
                        <div className="flex items-center justify-between">
                            ...
                            <Switch
                                ...
                                onCheckedChange={(checked) =>
                                    handleInputChange("pathao_enabled", checked)
                                }
                            />
                        </div>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div className="space-y-2">
                                <Label htmlFor="pathao_client_id">
                                    Client ID
                                </Label>
                                <Input
                                    id="pathao_client_id"
                    ...
                    <div className="space-y-4">
                        <div className="flex items-center justify-between">
                            ...
                            <Switch
                                ...
                                onCheckedChange={(checked) =>
                                    handleInputChange("redx_enabled", checked)
                                }
                            />
                        </div>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div className="space-y-2">
                                <Label htmlFor="redx_api_token">
                                    API Token
                                </Label>
                                <Input
                                    id="redx_api_token"
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div className="space-y-2">
                                <Label htmlFor="stedfast_api_key">
                                    API Key
                                </Label>
                                <Input
                                    id="stedfast_api_key"
                            ...
                            <div className="space-y-2">
                                <Label htmlFor="stedfast_secret_key">
                                    Secret Key
                                </Label>
                                <Input
                            ...
                            <div className="space-y-2 md:col-span-2">
                                <Label htmlFor="stedfast_base_url">
                                    Base URL
                                </Label>
                                <Input
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>
                        Configure payment gateway APIs for processing
                        transactions
                    </CardDescription>
                </CardHeader>
                <CardContent className="space-y-6">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div className="space-y-2">
                                <Label htmlFor="sslcommerz_store_id">
                                    Store ID
                                </Label>
                                <Input
                            ...
                            <div className="space-y-2">
                                <Label htmlFor="sslcommerz_store_password">
                                    Store Password
                                </Label>
                                <Input
                            ...
                            <div className="flex items-center space-x-2 md:col-span-2">
                                ...
                                />
                                <Label htmlFor="sslcommerz_sandbox_mode">
                                    Sandbox Mode
                                </Label>
                            </div>
                        </div>
                    ...
                    <div className="space-y-4">
                        <div className="flex items-center justify-between">
                            ...
                            <Switch
                                ...
                                onCheckedChange={(checked) =>
                                    handleInputChange("bkash_enabled", checked)
                                }
                            />
                        </div>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div className="space-y-2">
                                <Label htmlFor="bkash_app_secret">
                                    App Secret
                                </Label>
                                <Input
                                    id="bkash_app_secret"
                            ...
                            <div className="flex items-center space-x-2 md:col-span-2">
                                ...
                                />
                                <Label htmlFor="bkash_sandbox_mode">
                                    Sandbox Mode
                                </Label>
                            </div>
                        </div>
