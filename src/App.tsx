...
import { StoreSettingsProvider, useStoreName } from './contexts/StoreSettingsContext'
...
function AppContent() {
  ...
  return (
    <div className="min-h-screen bg-background" style={{ display: isLoading ? 'none' : 'block' }}>
      <Routes>
                  {/* Public routes */}
